"""
Django settings for aged_paper_dev_95432 project.
...
ROOT_URLCONF = 'aged_paper_dev_95432.urls'
...
WSGI_APPLICATION = 'aged_paper_dev_95432.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_paper_dev_95432 API",
    "DESCRIPTION": "API documentation for aged_paper_dev_95432 App",
    "VERSION": "v1",
}
